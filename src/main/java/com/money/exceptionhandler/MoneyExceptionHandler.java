...
public class MoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handlePessoaIllegalArgumentException(IllegalArgumentException ex) {

		String mensagemUsuario = messageSource.getMessage("codigo.nulo", null,LocaleContextHolder.getLocale());
		String mensagemDesenvolvedor = ex.toString();
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
